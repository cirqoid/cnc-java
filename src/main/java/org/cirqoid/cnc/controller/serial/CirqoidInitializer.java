...
public class CirqoidInitializer
{
    ...
    public static SetParametersCommand buildDiagnosticInitCommand(SerialInterface serialInterface)
    {
        ...
        packet.setAccelerationStartSpeed(1);
        ...
        if (serialInterface.getHardwareVersion() == 0)
        {
    ...
    private static void sendInitPacket(SerialInterface serialInterface, SetParametersCommand packet) throws SerialException
    {
